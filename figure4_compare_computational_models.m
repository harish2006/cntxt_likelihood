...
xx=squeeze(L2_cp.rectcar(id1024,:,4)./L2_cp.rectcar(id1024,:,3))';
...
xx=squeeze(L2_cp.rectperson(id1024,:,4)./L2_cp.rectperson(id1024,:,3))';
[c,~,~,stats.aspper.sem]=mysplithalfcorr(xx,100);
stats.aspper.sbc=spearmanbrowncorrection(c,2);

load rvals_likelihood_1000_wgist.mat;rvals_nc=rvals;
% load rvals_likelihood_100_gist.mat;rvals_gist=rvals;
rvals_gist=rvals;
load rvals_likelihood_1000_fullVgg;rvals_v=rvals;
load rvals_likelihood_1000_fullPlaces205;rvals_p=rvals;
load rvals_likelihood_1000_pixels;rvals_pix=rvals;
